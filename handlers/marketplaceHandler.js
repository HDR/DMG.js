...
client.on(Events.ThreadCreate, async thread => {
    if (thread.parentId === market_channel) {
        ...
        if (timeSinceJoin/1000/60/60/24 < 30 || timeSinceCreated/1000/60/60/24 < 90) {
            await thread.delete()
            await sendPM(threadOwner.guildMember, "Your post in the marketplace was deleted, Your account is either too new, or you have joined this server recently, please try again in a bit");
        } else {
            setTimeout(function() {
